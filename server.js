    ...
    if (process.env.EMAIL_USER) {
      try {
        await transporter.sendMail({
          from: `"${process.env.APP_NAME || 'Chimera'}" <${process.env.EMAIL_USER}>`,
          to: email,
          subject: `Bienvenue sur la waitlist ${process.env.APP_NAME || 'Chimera'} ! 🎉`,
          html: `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  ...
                  <p>Merci de votre intérêt pour <strong>${process.env.APP_NAME || 'Chimera'}</strong> !</p>
                  <div class="highlight">
                    <h2 style="margin: 0;">Votre position</h2>
                    <h1 style="margin: 10px 0; font-size: 48px;">#${entry.position}</h1>
                  </div>
                  ...
                  <div class="footer">
                    <p>À très bientôt,<br>L'équipe ${process.env.APP_NAME || 'Chimera'}</p>
                  </div>
                </div>
              </div>
            </body>
